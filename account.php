<?php
	...
	if (isset($_POST['submit'])) 
	{
		...
		if (!empty($username) and !empty($email)) 
		{
			...
			{
				$error = "O Usuário não é válido";
			}
			else if (preg_match("/[^a-zA-Z0-9\!]", $username)) 
			{
				$error['username'] = "Apenas números e caracteres são permetidos";
			}
			...
			{
				$error['email'] = "Email já está em uso!";
			}
			else
			{
		...
		{
			$error['fields'] = "Todos os campos são necessários";
		}
	}
?>
   ...
   <div class="nav">
		 <div class="nav-left">
			<ul>
				...
				<li id="messagePopup" rel="user_id"><i class="fa fa-envelope" aria-hidden="true"></i>Mensagens</li>
 			</ul>
		</div>
		<!-- nav left ends-->
		<div class="nav-right">
			...
			<div class="inner-righter">
				<div class="acc">
					<div class="acc-heading">
						<h2>Conta</h2>
						<h3>Configurações básicas da conta.</h3>
					</div>
