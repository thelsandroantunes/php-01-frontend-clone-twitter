$(function()
{
	$(document).on('click', '.retweet', function()
	{
		...
		$.post('http://localhost/WebDeveloper/Twitter-Clone/core/ajax/retweet.php', 
	...
	$(document).on('click', '.retweet-it', function()
	{
		...
		$.post('http://localhost/WebDeveloper/Twitter-Clone/core/ajax/retweet.php', {retweet:$tweet_id, user_id:$user_id, comment:comment}, function()
			{
				$('.retweet-popup').hide();
				$count++;
				$counter.text($count);
